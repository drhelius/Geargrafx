...
enum GG_Trace_Input_Event : u8
{
    TRACE_INPUT_READ = 0,
    TRACE_INPUT_WRITE,
    TRACE_INPUT_TURBOLINK_CONTROL_WRITE,
    TRACE_INPUT_TURBOLINK_DRIVE_CHANGE,
    TRACE_INPUT_TURBOLINK_SAMPLE,
    TRACE_INPUT_TURBOLINK_CABLE,
};
...
enum GG_Trace_CDROM_Event : u8
{
    ...
    TRACE_CDROM_AUDIO_PLAYBACK_START,
};
...
static_assert(TRACE_VDC_VPC_REG_WRITE < 32 && TRACE_VCE_VSYNC_END < 32 &&
    TRACE_INPUT_TURBOLINK_CABLE < 32 && TRACE_TIMER_CONTROL_WRITE < 32 &&
    TRACE_ADPCM_END_IRQ < 32 && TRACE_CDROM_AUDIO_PLAYBACK_START < 32 &&
    TRACE_SCSI_SECTOR_RETRY < 32 && TRACE_PSG_LFO_CONTROL < 32 &&
...
#define TRACE_INPUT_FILTER_TURBOLINK_WRITES   TRACE_EVENT_FLAG(TRACE_INPUT_TURBOLINK_CONTROL_WRITE)
#define TRACE_INPUT_FILTER_TURBOLINK_DRIVE    TRACE_EVENT_FLAG(TRACE_INPUT_TURBOLINK_DRIVE_CHANGE)
#define TRACE_INPUT_FILTER_TURBOLINK_SAMPLES  TRACE_EVENT_FLAG(TRACE_INPUT_TURBOLINK_SAMPLE)
#define TRACE_INPUT_FILTER_TURBOLINK_CABLE    TRACE_EVENT_FLAG(TRACE_INPUT_TURBOLINK_CABLE)
#define TRACE_INPUT_FILTER_TURBOLINK          \
...
#define TRACE_INPUT_FILTER_ALL                \
    (TRACE_INPUT_FILTER_READS | TRACE_INPUT_FILTER_WRITES | \
     TRACE_INPUT_FILTER_TURBOLINK)
...
#define TRACE_CDROM_FILTER_AUDIO              \
    (TRACE_EVENT_FLAG(TRACE_CDROM_AUDIO_START) | TRACE_EVENT_FLAG(TRACE_CDROM_AUDIO_SEEK_END) | \
     ...
     TRACE_EVENT_FLAG(TRACE_CDROM_AUDIO_BOUNDARY) | TRACE_EVENT_FLAG(TRACE_CDROM_AUDIO_PLAYBACK_START))
...
#define TRACE_SCSI_FILTER_TRANSFERS           TRACE_EVENT_FLAG(TRACE_SCSI_SECTOR_RETRY)
...
#define TRACE_SCSI_FILTER_ALL                 \
    (TRACE_SCSI_FILTER_COMMANDS | TRACE_SCSI_FILTER_PHASES | TRACE_SCSI_FILTER_RESPONSES | \
     TRACE_SCSI_FILTER_RESPONSE_BYTES | TRACE_SCSI_FILTER_TRANSFERS | TRACE_SCSI_FILTER_PROBLEMS)
...
static_assert(sizeof(GG_Trace_Entry) <= 96, "Trace entry exceeds memory budget");
