...
#define GG_PSG_CLOCK_RATE (GG_MASTER_CLOCK_RATE / 6)
#define GG_PSG_CYCLES_PER_SAMPLE (GG_PSG_CLOCK_RATE / GG_AUDIO_SAMPLE_RATE)
#define GG_CDAUDIO_CYCLES_PER_SAMPLE (GG_MASTER_CLOCK_RATE / GG_AUDIO_SAMPLE_RATE)

#define GG_SAVESTATE_VERSION 21
