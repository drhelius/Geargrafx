...
const GG_Game_DB_Entry k_game_database[] =
{
    ...
    // AVENUE PAD 3
    { 0x933D5BCC, "Air Zonk", GG_GAMEDB_AVENUE_PAD_3_SELECT },
    { 0xCA72A828, "After Burner II", GG_GAMEDB_AVENUE_PAD_3_RUN },
    { 0x0, "Akumajou Dracula X: Chi no Rondo", GG_GAMEDB_AVENUE_PAD_3_SELECT },
    { 0xCACC06FB, "Ankoku Densetsu", GG_GAMEDB_AVENUE_PAD_3_RUN },
    { 0x0, "Atlantean", GG_GAMEDB_AVENUE_PAD_3_RUN },
    { 0x4A3DF3CA, "Barunba", GG_GAMEDB_AVENUE_PAD_3_SELECT },
    { 0xE70B01AF, "Battle Royale", GG_GAMEDB_AVENUE_PAD_3_SELECT },
    { 0xB4A1B0F6, "Blazing Lazers", GG_GAMEDB_AVENUE_PAD_3_SELECT },
    { 0x37BAF6BC, "Bloody Wolf", GG_GAMEDB_AVENUE_PAD_3_RUN },
    { 0xA98D276A, "Cyber Core (J)", GG_GAMEDB_AVENUE_PAD_3_SELECT },
    { 0x4CFB6E3E, "Cyber Core (USA)", GG_GAMEDB_AVENUE_PAD_3_SELECT },
    { 0x85101C20, "Download", GG_GAMEDB_AVENUE_PAD_3_SELECT },
    { 0x4E0DE488, "Download [Alt]", GG_GAMEDB_AVENUE_PAD_3_SELECT },
    { 0x560D2305, "Final Match Tennis", GG_GAMEDB_AVENUE_PAD_3_RUN },
    { 0xAF2DD2AF, "Final Soldier", GG_GAMEDB_AVENUE_PAD_3_SELECT },
    ...
    { 0x220EBF91, "Legendary Axe 2", GG_GAMEDB_AVENUE_PAD_3_RUN },
    { 0x0, "Martial Champion", GG_GAMEDB_AVENUE_PAD_3_RUN },
    { 0x0, "Metamor Jupiter", GG_GAMEDB_AVENUE_PAD_3_SELECT },
    { 0xDE8AF1C1, "Ninja Spirit", GG_GAMEDB_AVENUE_PAD_3_SELECT },
    { 0x0, "Riot Zone", GG_GAMEDB_AVENUE_PAD_3_RUN },
    { 0xBC655CF3, "Shinobi", GG_GAMEDB_AVENUE_PAD_3_SELECT },
    ...
    { 0xF39F38ED, "Soldier Blade (USA) [Special - Caravan Stage]", GG_GAMEDB_AVENUE_PAD_3_SELECT },
    { 0x9DB3C8C7, "Special Criminal Investigation", GG_GAMEDB_AVENUE_PAD_3_SELECT },
    ...
    { 0xEB045EDF, "Turrican", GG_GAMEDB_AVENUE_PAD_3_SELECT },
