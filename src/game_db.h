...
const GG_DB_Entry k_game_database[] =
{
    ...
    // SGX-CD
    { 0xBB22DAB5, "Space Ava 201 - Release v1.01", GG_GAMEDB_SGX_REQUIRED | GG_GAMEDB_ARCADE_CARD },
    ...
    { 0x28B72810, "Akumajou Dracula X - Chi no Rondo (J)", GG_GAMEDB_AVENUE_PAD_3_SELECT },
    { 0xA1996DD5, "Akumajou Dracula X - Chi no Rondo (J) [Alt]", GG_GAMEDB_AVENUE_PAD_3_SELECT },
    ...
    { 0x7FF6BE90, "Forgotten Worlds (J)", GG_GAMEDB_AVENUE_PAD_3_SELECT },
    { 0x8C70F1C0, "Forgotten Worlds (USA)", GG_GAMEDB_AVENUE_PAD_3_SELECT },
    { 0xF175D704, "Gate of Thunder (J)", GG_GAMEDB_AVENUE_PAD_3_SELECT },
    { 0xD58E6C61, "Golden Axe (J)", GG_GAMEDB_AVENUE_PAD_3_SELECT },
    ...
    { 0xDAE8F28D, "Riot Zone (USA)", GG_GAMEDB_AVENUE_PAD_3_RUN },
    ...
    { 0x23162307, "Spriggan Mark 2 - Re Terraform Project (J)", GG_GAMEDB_AVENUE_PAD_3_SELECT },
