...
EXTERN bool ogl_shader_chain_update_source_texture(int width, int height, const void* pixels, bool filter_linear);
EXTERN bool ogl_shader_chain_resize_pass_texture(int width, int height, bool filter_linear);

EXTERN bool ogl_shader_chain_load_preset(const char* path);
EXTERN bool ogl_shader_chain_reload_preset(void);
...
EXTERN void ogl_shader_chain_get_preset_pass_output_size(int index, int source_width, int source_height, int previous_width, int previous_height, int viewport_width, int viewport_height, int* width, int* height);
...
EXTERN void ogl_shader_chain_apply_preset_uniforms(int index, int source_width, int source_height, int input_width, int input_height, int output_width, int output_height, int viewport_width, int viewport_height, float original_aspect);
...
EXTERN bool ogl_shader_chain_resize_intermediate_texture(int index, int width, int height, bool filter_linear);
