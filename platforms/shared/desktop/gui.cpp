...
static void set_style(void)
{
    ...
    style.Colors[ImGuiCol_FrameBg] = ImVec4(0.1158786714076996f, 0.1158786714076996f, 0.1158798336982727f, 1.0f);
    ...
    style.Colors[ImGuiCol_Header] = ImVec4(0.1176470592617989f, 0.1176470592617989f, 0.1176470592617989f, 1.0f);
